...
describe('App', function() {
  ...
  it('should contain some text in the page', (done) => {
    api.get('/').end((err, res) => {
      should.not.exist(err);
      console.log('res.body', res.body); // the body is empty, weird. Can i see the server.js file? ? hmmmm, its on the tab trying to figure out if you can see it .. Cant see it just the unit.js
      done();
    })
  })
});
